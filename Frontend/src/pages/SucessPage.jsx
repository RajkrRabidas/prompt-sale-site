    ...
    const checkStatus = async () => {
      try {
        ...
        const res = await axios.get(
          `${API_BASE}/payment/status/${orderId}`
        );
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#f3f5f6] p-5 font-sans">
        <div className="w-full max-w-[420px] bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-white">
            <button
              className="bg-transparent border-0 text-lg cursor-pointer"
              onClick={() => navigate(-1)}
            >
              &larr;
            </button>
        ...
        <div className="w-full max-w-[420px] bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-4 flex flex-col gap-4">
            ...
            <div className="bg-[#fafafa] rounded-md p-3 flex flex-col gap-2">
              <div className="text-xs text-gray-600 font-bold tracking-wider pl-1">
                DETAILS
              </div>
              ...
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <div className="text-gray-900 font-semibold text-sm">{new Date(payment.createdAt).toLocaleTimeString()}</div>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
              ...
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                <div className="text-gray-500 text-sm">Session ID</div>
                <div className="text-gray-900 font-semibold text-sm">
                  {maskId(payment.sessionId)}
                </div>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
            ...
            <button
              className="mt-1 bg-[#0e7f73] text-white rounded-md px-4 py-3 cursor-pointer font-semibold"
              onClick={() => navigate("/")}
            >
              Done
            </button>
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#f3f5f6] p-5 font-sans">
        <div className="w-full max-w-[420px] bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-6 flex flex-col items-center gap-2">
            ...
            <p className="text-gray-500 max-w-[280px] text-center">
              If money was deducted, it will be auto-refunded. Try again or
              contact support.
            </p>

            <div className="flex gap-3 mt-4">
              <button
                className="mt-1 bg-transparent text-[#0e7f73] border border-[#dfecec] rounded-md px-3 py-2 cursor-pointer font-semibold"
                onClick={() => navigate(-1)}
              >
                Back
              </button>
